...
namespace Triangle
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                myTriangle = new Triangle(new Point(1, 1), new Point(4, 1), new Point(4, 5));
            }
            catch(Exception e)
            {
            ...
            Polygon nAngles = new Polygon ( new[] { new Point(1, 1), new Point(4, 1), new Point(1, 4), new Point(4, 4) });
